...
2) Реализовал локализацию. Но покрыта не все приложение. Кнопка смены языка в главном экране, наверху справа

3) Реализовал возможность сохранения черновика формы регистрации.
При перезапуске:
...
4) Шаги регистрации выполнял по фигме. Некоторые моменты брал из ТЗ.

5) В экране Профиль можно редактирвоать профиль, и есть кнопка выход из аккаа
